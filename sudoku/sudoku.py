...
def main():
        ...
        state=2
        can.create_line(0,0,width,0,fill="#000000",width=4)

        s=50
        s2=10
        can.create_polygon(width/2-s,0, width/2+s,0, width/2+s-s2,30, width/2-s+s2,30, fill="#000000",outline="#000000")


        can.create_text(width/2,15,text=game_mode,font=("FreeMono",13),fill="#ffffff",anchor="c")
        can.create_text(10,20,text="mistakes - "+str(mistakes),font=("FreeMono",13),fill="#000000",anchor="w")
        ...
        if not sel==0:
                can.create_rectangle(10+sel[0]*sz,40+sel[1]*sz, 10+sel[0]*sz+sz,40+sel[1]*sz+sz,fill="#555555",outline="#555555")
                ...
                for x in range(9):
                        ...
                        if viewable[y][x]!=0:
                                ...
                                if viewable[y][x]==sel2:
                                        can.create_rectangle(10+x*sz,40+y*sz, 10+x*sz+sz,40+y*sz+sz,fill="#555555",outline="#555555")
        ...
        if view_pos_moves==1:
                ...
                for _ in possible_sol:
                        ...
                        for v in _[-1]:
                                ...
                                if v==sel2:
                                        can.create_rectangle(x-vv/2,y-vv/2, x+vv-vv/2,y+vv-vv/2, fill="#555555",outline="#555555")
                                        col="#ffffff"
